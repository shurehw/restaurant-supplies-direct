...
export default function LABanner() {
  ...
  return (
    <div className="bg-gradient-to-r from-primary-600 to-primary-700 text-white py-4 px-4 sm:px-6 lg:px-8 relative">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        <div className="flex-1">
          <p className="text-sm sm:text-base">
            ...
            <a
              ...
              className="underline hover:text-accent-50 transition-colors"
              target="_blank"
        ...
        <div className="flex items-center gap-3">
          <Link
            ...
            className="whitespace-nowrap text-sm font-medium bg-white text-primary-600 px-4 py-2 rounded-lg hover:bg-accent-50 transition-colors"
